# wicket-notes-demo [![Build Status] ![Java CI with Maven](https://github.com/r-h/wicket-notes-demo/workflows/Java%20CI%20with%20Maven/badge.svg) Travis: (https://travis-ci.org/r-h/wicket-notes-demo.svg?branch=master)](https://travis-ci.org/r-h/wicket-notes-demo)
